...
export default function DownloadInputBar() {
    ...
    return (
        <div className="flex w-full flex-row items-center gap-2 px-2 py-2">
            <input
                type="url"
                className="w-full rounded-full bg-neutral-800 px-4 py-2 text-sm text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-[#ee1086]/40 transition-all"
