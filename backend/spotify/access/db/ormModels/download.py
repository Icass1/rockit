...
class DownloadRow(SpotifyBase, TableAutoincrementId, TableDateUpdated, TableDateAdded):
    ...
    download_status_key: Mapped[int] = mapped_column(Integer, ForeignKey(
        'spotify.download_status_enum.key'), nullable=False, default=0)
    ...
    def __init__(self, public_id: str, user_id: int, date_started: datetime, download_url: str, date_ended: datetime | None = None, download_status_key: int = 0, seen: bool = False, success: int | None = None, fail: int | None = None):
