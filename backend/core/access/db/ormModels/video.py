...
class CoreVideoRow(CoreBase, TableAutoincrementId, TablePublicId, TableDateUpdated, TableDateAdded):
    __tablename__ = 'video'
    ...
    def __init__(self, public_id: str, name: str, view_type: str, description: str | None = None, provider_id: int | None = None):
