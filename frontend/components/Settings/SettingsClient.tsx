...
import { UserProfileSection, ChangeUsernameInput } from "@/components/Settings/hooks/useSettingsUser";
                ...
                <div className="flex w-full flex-col items-center justify-center border-b border-gray-700 pb-8 md:mt-0 md:h-full md:w-1/3 md:border-r md:border-b-0 md:pb-0">
                    <div className="group relative flex items-center justify-center">
                        <Image
                            ...
                            width={360}
                            height={360}
                            className="h-48 rounded-full bg-neutral-400 aspect-square object-cover w-auto shadow-md transition duration-300 md:h-72"
                        />
