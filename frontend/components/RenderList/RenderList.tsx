...
export default async function RenderList({
    ...
    return (
        <div className="grid h-full w-full grid-cols-[1fr_3fr] gap-4">
            <div className="z-1 h-full w-full min-w-0 max-w-full pb-24 pt-24">
            ...
            <div className="z-1 flex h-full w-full min-w-0 max-w-full flex-col gap-4 overflow-y-auto pb-96 pt-24">
