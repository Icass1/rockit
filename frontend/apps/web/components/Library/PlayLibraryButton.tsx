...
export default function PlayLibraryButton(): JSX.Element {
    ...
    return (
        <div
            onClick={handleClick}
            title="Play library"
            className="h-8 w-8 cursor-pointer rounded-full bg-gradient-to-r from-[#ee1086] to-[#fb6467] shadow-[0px_0px_20px_3px_#0e0e0e] transition-transform md:hover:scale-105"
        >
