    ...
    return (
        <>
            <div
                ...
                className="bg-linear-to-r h-8 w-8 cursor-pointer rounded-full from-[#ee1086] to-[#fb6467] shadow-[0px_0px_20px_3px_#0e0e0e] transition-transform md:h-10 md:w-10 md:hover:scale-105"
            >
                {icon}
            </div>
        </>
