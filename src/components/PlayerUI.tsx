                        ...
                        {currentTab === "queue" ? (
                            ...
                            <>
                                <section>
                                    ...
                                    <div className="flex gap-4 overflow-x-auto md:overflow-hidden md:hover:overflow-x-auto scrollbar-hide snap-x snap-mandatory px-2 py-2 md:[scrollbar-gutter:stable]">
                                ...
                                <section>
                                    ...
                                    <div className="flex gap-7 overflow-x-auto md:overflow-hidden md:hover:overflow-x-auto scrollbar-hide snap-x snap-mandatory py-4 px-2">
