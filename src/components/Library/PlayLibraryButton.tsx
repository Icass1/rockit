...
export default function PlayLibraryButton() {
    ...
    return (
        <div
            ...
            className="h-8 w-8 translate-y-1/12 cursor-pointer rounded-full bg-gradient-to-r from-[#ee1086] to-[#fb6467] shadow-[0px_0px_20px_3px_#0e0e0e] transition-transform md:h-10 md:w-10 md:hover:scale-105"
        >
            {icon}
        </div>
    );
