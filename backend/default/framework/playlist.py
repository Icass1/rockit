...
class Playlist:
    ...
    async def create_playlist_async(
        ...
        if a_result_playlist.is_not_ok():
            logger.error(
                f"Error creating playlist. {a_result_playlist.info()}"
            )
            return AResult(
    ...
    async def get_playlist_async(
        ...
        if a_result_playlist.is_not_ok():
            logger.error(
                f"Error getting playlist. {a_result_playlist.info()}"
            )
            return AResult(
                code=a_result_playlist.code(),
                message=a_result_playlist.message(),
    ...
    async def update_playlist_async(
        ...
        if a_result_playlist.is_not_ok():
            logger.error(
                f"Error updating playlist. {a_result_playlist.info()}"
            )
            return AResult(
                code=a_result_playlist.code(),
                message=a_result_playlist.message(),
    ...
    async def add_media_to_playlist_async(
        ...
        if a_result.is_not_ok():
            logger.error(
                f"Error adding media to playlist. {a_result.info()}"
            )
            return AResult(
                code=a_result.code(),
                message=a_result.message(),
    ...
    async def remove_media_from_playlist_async(
        ...
        if a_result.is_not_ok():
            logger.error(
                f"Error removing media from playlist. {a_result.info()}"
            )
            return AResult(
                code=a_result.code(),
                message=a_result.message(),
    ...
    async def remove_contributor_async(
        ...
        if a_result.is_not_ok():
            logger.error(
                f"Error removing contributor. {a_result.info()}"
            )
            return AResult(
                code=a_result.code(),
                message=a_result.message(),
