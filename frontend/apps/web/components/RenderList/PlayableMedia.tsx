    ...
    return (
        ...
        >
            ...
            >
                ...
                {showMediaImage && (
                    <Image
                        className="h-12 w-auto rounded select-none"
                        src={$media.imageUrl}
                        alt={$media.name}
                        width={50}
                        height={50}
                ...
                <div
                    className={`${isLiked ? "" : "pointer-events-none opacity-0 group-hover:pointer-events-auto group-hover:opacity-100"} transition-all duration-200`}
                >
