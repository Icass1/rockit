...
const ACTION_REGISTRY: ActionDef[] = [
    ...
    },
    {
        ...
        type: "action",
        icon: HardDriveDownload,
        labelKey: "DOWNLOAD_TO_SERVER",
        mediaTypes: [EMediaType.Song, EMediaType.Video],
        locations: [EMediaContextLocation.SEARCH],
        condition: (m) => isSearchResult(m) && !m.downloaded,
    },
    {
        id: EMediaContextAction.DownloadSearchResultAndAddToLibrary,
        type: "action",
        icon: HardDriveDownload,
        labelKey: "DOWNLOAD_AND_ADD_TO_LIBRARY",
        mediaTypes: [EMediaType.Song, EMediaType.Video],
        locations: [EMediaContextLocation.SEARCH],
        condition: (m) => isSearchResult(m) && !m.downloaded,
    },
    ...
    {
        id: EMediaContextAction.DeleteMediaFile,
        type: "action",
        icon: Trash2,
        labelKey: "DELETE",
        mediaTypes: [EMediaType.Song, EMediaType.Video],
...
const MEDIA_BLUEPRINTS: Partial<Record<EMediaType, BlueprintEntry[]>> = {
    [EMediaType.Song]: [
        ...
        EMediaContextAction.DeleteMediaFile,
