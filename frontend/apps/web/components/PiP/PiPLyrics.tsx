...
export function PiPLyrics(): JSX.Element | null {
  ...
  if (loading) {
    return (
      <div className="pip-lyrics-overlay" data-testid="pip-lyrics-loading">
    ...
    <div className="pip-lyrics-overlay" data-testid="pip-lyrics">
      <div ref={scrollRef} className="pip-lyrics-scroll">
        {syncedLines.map((line, i) => {
          ...
          if (i < currentLineIndex) className += " pip-lyrics-line--past";
          else if (i === currentLineIndex) className += " pip-lyrics-line--current";
          ...
          return (
            <span
              ...
              tabIndex={0}
              onKeyDown={(e): void => {
                if (e.key === "Enter" || e.key === " ") goToLine(i);
              }}
            >
              {line.text}
            </span>
