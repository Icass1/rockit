...
from backend.spotifyScrapper.access.db.ormModels.albumCache import CacheAlbumRow
from backend.spotifyScrapper.access.db.ormModels.trackCache import CacheTrackRow
from backend.spotifyScrapper.access.db.ormModels.artistCache import CacheArtistRow
from backend.spotifyScrapper.access.db.ormModels.playlistCache import CachePlaylistRow

logger = getLogger(__name__)


class SpotifyScrapperCacheAccess:
    @staticmethod
    ...
    async def add_album_async(
        ...
        try:
            ...
            return AResultCode(
                code=AResultCode.GENERAL_ERROR,
                message=f"Failed to add album to cache: {e}.",
            )
