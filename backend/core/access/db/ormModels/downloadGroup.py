...
from backend.core.access.db.ormModels.declarativeMixin import (
    TableAutoincrementId, TableDateAdded, TableDateUpdated, TablePublicId)

if TYPE_CHECKING:
    from backend.core.access.db.ormModels.download import DownloadRow


class DownloadGroupRow(CoreBase, TableAutoincrementId, TablePublicId, TableDateUpdated, TableDateAdded):
    ...
    status_key: Mapped[int] = mapped_column(
        Integer,
        ForeignKey('core.download_status_enum.key'),
        nullable=False,
        default=1)
    ...
    def __init__(self, public_id: str, user_id: int, title: str, date_started: datetime, date_ended: datetime | None = None, status_key: int = 1, success: int | None = None, fail: int | None = None):
