...
class RawRockItApiSong:
    ...
    def from_dict(obj: Any) -> 'RawRockItApiSong':
        ...
        return RawRockItApiSong(_id, _name, _artists, _genres, _discNumber, _albumName, _albumArtist, _albumType, _albumId, _duration, _date, _trackNumber, _publisher, _path, _images, _image, _copyright, _downloadUrl, _lyrics, _dynamicLyrics, _popularity, _dateAdded, obj)
    def __getitem__(self, item):
        if item == 'id':
            return self.id
        elif item == 'name':
